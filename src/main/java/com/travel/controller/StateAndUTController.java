...
public class StateAndUTController {
	...
	@PutMapping("/updateStateAndUT/{id}")
	public StateAndUTDto updateStateAndUT(@PathVariable("id") int stateAndUTId, @Valid @RequestBody StateAndUTDto stateAndUTDto)
	{
		final StateAndUT StateAndUT = stateAndUTConverter.convertDtoToEntity(stateAndUTDto);
		return stateAndUTService.updateStateAndUT(stateAndUTId, StateAndUT);
	}
}